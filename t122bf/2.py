...
class Game:
    nivel_actual_indice = 0  # Variable de clase para poder ser reiniciado al comenzar el juego y guardarse el estado al cambiar de nivel
    
    @staticmethod
    def cargar_nivel(indice_nivel):
        Game.nivel_actual_indice = indice_nivel
        return cargar_nivel(Game.nivel_actual_indice)
