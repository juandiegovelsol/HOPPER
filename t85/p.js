...
parser.on("readable", () => {
  ...
  while ((record = parser.read()) !== null) {
    ...
    if (
      ...
      console.warn(
        `Advertencia: partido entre ${jugador1} y ${jugador2} tiene un formato de sets inválido.`
      );
      continue;
    }
    ...
    if (setsJugador1 === 3 && setsJugador1 > setsJugador2) {
      ...
      console.warn(
        `Advertencia: partido entre ${jugador1} y ${jugador2} tiene un marcador inválido.`
      );
      continue;
    }
