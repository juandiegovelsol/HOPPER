...
def nequalize(arreglo, p=5):
    ...
    if len(arreglo.shape) == 2:
        ...
        if vmin == vmax:
            ...
            arreglo_norm[arreglo_norm > 1] = 1
            arreglo_norm[arreglo_norm < 0] = 0
        ...
        for i in range(arreglo.shape[0]):
            arreglo_norm[i] = nequalize(arreglo_norm[I])
    else:
...
# -1 será considerado un valor no válido
valor_no_valido = -1
